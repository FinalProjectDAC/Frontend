  ...
  return (<nav className="navbar navbar-expand-lg bg-body-tertiary">
    ...
    <div className="container-fluid">
      ...
      <div className="dropdown col-2">
        <a onClick={()=>{}} className="btn btn-secondary dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          Select City
        </a>
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <form className="d-flex col-6" role="search">
          <input list="data" className="form-control me-3 " type="search" placeholder="Search by resturant, cusine or dish" aria-label="Search" onChange={()=>{}} />
          <datalist id='data'>
            {
              search.map(ele => {
                return (
